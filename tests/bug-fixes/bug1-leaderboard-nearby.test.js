...
describe('Bug Fix #1: LeaderboardModule nearbyCount default', () => {
  ...
  it('should NOT include nearby users when includeUser is used without nearbyCount', async () => {
  ...
  it('should include nearby users when nearbyCount is explicitly provided', async () => {
    // Setup: Add users to leaderboard
    await leaderboardModule.updateScore('global', 'user1', 500);
    await leaderboardModule.updateScore('global', 'user2', 300);
    await leaderboardModule.updateScore('global', 'user3', 700);
