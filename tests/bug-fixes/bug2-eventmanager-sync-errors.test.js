...
describe('Bug Fix #2: EventManager handles synchronous errors', () => {
  let eventManager;
  ...
  it('should catch synchronous errors in listeners without throwing', async () => {
  ...
  it('should catch errors from multiple failing listeners', async () => {
