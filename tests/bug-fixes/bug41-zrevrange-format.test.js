...
describe('Bug Fix #41: Storage zrevrange returns consistent format', () => {
  let storage;
  ...
  test('should return array of objects with withScores option', async () => {
  ...
  test('should return array of members without withScores option', async () => {
  ...
  test('zrange should return array of objects with withScores option', async () => {
