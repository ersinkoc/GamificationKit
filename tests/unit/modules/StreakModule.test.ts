...
describe('StreakModule', (): void => {
  ...
  describe('recordActivity', (): void => {
    it('should start a new streak', async (): Promise<void> => {
    ...
    it('should continue existing streak', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
    ...
    it('should break streak if grace period exceeded', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should preserve longest streak', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should detect milestone reached', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should emit streaks.continued event for new streak', async (): Promise<void> => {
    ...
    it('should emit streaks.continued event for continued streak', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should emit streaks.broken event', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should emit streaks.milestone.achieved event', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should handle single streak type only', async (): Promise<void> => {
  ...
  describe('getStreakData', (): void => {
    it('should return streak data', async (): Promise<void> => {
      await streakModule.recordActivity('user123', 'daily');
    ...
    it('should return default for non-existent streak', async (): Promise<void> => {
      const streak = await streakModule.getStreakData('user123', 'daily');
  ...
  describe('getUserStreaks', (): void => {
    beforeEach(async () => {
      await streakModule.recordActivity('user123', 'daily');
    });

    it('should return all user streaks', async (): Promise<void> => {
    ...
    it('should calculate progress to next milestone', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
  ...
  describe('freeze system', (): void => {
    beforeEach(async () => {
      await streakModule.recordActivity('user123', 'daily');
    });

    it('should freeze streak', async (): Promise<void> => {
    ...
    it('should preserve streak during freeze', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should break streak if freeze expired', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
    ...
    it('should limit freezes', async (): Promise<void> => {
    ...
    it('should emit streaks.frozen event', async (): Promise<void> => {
      const emitSpy = jest.spyOn(streakModule, 'emitEvent');
    ...
    it('should not freeze streak with no active streak', async (): Promise<void> => {
  ...
  describe('break streak', (): void => {
    it('should manually break streak', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
  ...
  describe('getTopStreaks', (): void => {
    ...
    it('should return current streak leaderboard', async (): Promise<void> => {
    ...
    it('should return longest streak leaderboard', async (): Promise<void> => {
  ...
  describe('getUserStats', (): void => {
    ...
    it('should return user stats', async (): Promise<void> => {
    ...
    it('should handle user with no streaks', async (): Promise<void> => {
  ...
  describe('addFreezeItems', (): void => {
    it('should add freeze items', async (): Promise<void> => {
    ...
    it('should add global freeze items', async (): Promise<void> => {
  ...
  describe('milestone rewards', (): void => {
    it('should process milestone rewards', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
  ...
  describe('resetUser', (): void => {
    ...
    it('should reset all user streaks', async (): Promise<void> => {
  ...
  describe('error handling', (): void => {
    ...
    it('should validate streak types', async (): Promise<void> => {
      await expect(
    ...
    it('should handle activity within same window', async (): Promise<void> => {
      jest.useFakeTimers();
      const now = Date.now();
      jest.setSystemTime(now);
