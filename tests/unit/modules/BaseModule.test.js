...
describe('BaseModule', () => {
  ...
  describe('initialize', () => {
    ...
    it('should call onInitialize and setupEventListeners', async () => {
      const onInitSpy = jest.spyOn(baseModule, 'onInitialize');
  ...
  describe('emitEvent', () => {
    ...
    it('should emit event with module prefix', async () => {
    ...
    it('should include module name in event data', async () => {
      const emitSpy = jest.spyOn(mockContext.eventManager, 'emitAsync');
  ...
  describe('recordMetric', () => {
    it('should record metric when metricsCollector is available', async () => {
    ...
    it('should not throw when metricsCollector is not available', async () => {
      baseModule.setContext(mockContext);
  ...
  describe('inheritance', () => {
    ...
    it('should allow extending BaseModule', async () => {
    ...
    it('should use overridden getUserStats', async () => {
      const testModule = new TestModule();
      testModule.setContext(mockContext);
