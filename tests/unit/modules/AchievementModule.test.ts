...
describe('AchievementModule', (): void => {
  ...
  describe('constructor and initialization', (): void => {
    ...
    it('should merge config properly', async (): Promise<void> => {
  ...
  describe('unlock', (): void => {
    ...
    it('should unlock achievement successfully', async (): Promise<void> => {
    ...
    it('should prevent duplicate unlocks', async (): Promise<void> => {
    ...
    it('should require previous tier when progression enabled', async (): Promise<void> => {
    ...
    it('should allow any tier when progression disabled', async (): Promise<void> => {
    ...
    it('should emit events on unlock', async (): Promise<void> => {
    ...
    it('should process rewards correctly', async (): Promise<void> => {
    ...
    it('should apply tier multipliers to rewards', async (): Promise<void> => {
      const eventSpy = jest.spyOn(eventManager, 'emitAsync');
    ...
    it('should update achievement score and leaderboard', async (): Promise<void> => {
      await achievementModule.unlock('user123', 'explorer', 'bronze');
    ...
    it('should handle disabled achievements', async (): Promise<void> => {
  ...
  describe('updateProgress', (): void => {
    ...
    it('should increment progress', async (): Promise<void> => {
    ...
    it('should set absolute progress', async (): Promise<void> => {
    ...
    it('should respect tier progression', async (): Promise<void> => {
    ...
    it('should handle missing achievement', async (): Promise<void> => {
      const result = await achievementModule.updateProgress('user123', 'nonexistent', 10);
      expect(result).toBeNull();
    });

    it('should emit progress events', async (): Promise<void> => {
      const emitSpy = jest.spyOn(achievementModule, 'emitEvent');
  ...
  describe('getUserAchievements', (): void => {
    it('should return empty array for new user', async (): Promise<void> => {
      const achievements = await achievementModule.getUserAchievements('newuser');
      expect(achievements).toEqual([]);
    });

    it('should return all user achievements', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'test1',
        name: 'Test 1',
  ...
  describe('getUserProgress', (): void => {
    ...
    it('should return progress for specific achievement', async (): Promise<void> => {
    ...
    it('should return null for nonexistent achievement', async (): Promise<void> => {
      const progress = await achievementModule.getUserProgress('user123', 'fake');
      expect(progress).toBeNull();
    });

    it('should return all progress when no achievement specified', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'test2',
        name: 'Test 2',
    ...
    it('should exclude hidden achievements unless unlocked', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'hidden',
        name: 'Hidden',
        hidden: true,
  ...
  describe('checkAchievementProgress', (): void => {
    it('should track events and update progress', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'login_streak',
        name: 'Login Streak',
        tiers: { bronze: { requirement: 5 } },
    ...
    it('should use default value when field missing', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'actions',
        name: 'Actions',
        tiers: { bronze: { requirement: 10 } },
  ...
  describe('getTopScorers', (): void => {
    it('should return top scorers with details', async (): Promise<void> => {
      // Create achievements
      achievementModule.addAchievement({
        id: 'ach1',
        name: 'Achievement 1',
    ...
    it('should handle empty leaderboard', async (): Promise<void> => {
      const topScorers = await achievementModule.getTopScorers(10);
      expect(topScorers).toEqual([]);
    });
  });

  describe('getAllAchievements', (): void => {
    it('should return all visible achievements', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'visible1',
        name: 'Visible 1',
        tiers: { bronze: { requirement: 1 } }
    ...
    it('should include hidden when requested', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'visible',
        name: 'Visible',
        tiers: { bronze: { requirement: 1 } }
  ...
  describe('getAchievementStats', (): void => {
    it('should return achievement statistics', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'popular',
  ...
  describe('getUserStats', (): void => {
    it('should return comprehensive user statistics', async (): Promise<void> => {
      // Add achievements
      achievementModule.addAchievement({
        id: 'gameplay1',
        name: 'Gameplay 1',
  ...
  describe('resetUser', (): void => {
    it('should reset all user achievement data', async (): Promise<void> => {
  ...
  describe('edge cases and error handling', (): void => {
    it('should handle concurrent unlocks', async (): Promise<void> => {
      achievementModule.addAchievement({
        id: 'concurrent',
        name: 'Concurrent',
        tiers: { bronze: { requirement: 1 } }
    ...
    it('should handle invalid achievement IDs gracefully', async (): Promise<void> => {
