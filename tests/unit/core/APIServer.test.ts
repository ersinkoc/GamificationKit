...
describe('APIServer', (): void => {
  ...
  describe('start', (): void => {
    it('should start the server successfully', async (): Promise<void> => {
    ...
    it('should handle server start error', async (): Promise<void> => {
  ...
  describe('stop', (): void => {
    it('should stop the server', async (): Promise<void> => {
      await apiServer.start();
      await apiServer.stop();
      expect(mockServer.close).toHaveBeenCalled();
    });

    it('should close all websocket clients', async (): Promise<void> => {
      await apiServer.start();
    ...
    it('should handle stop when server is not started', async (): Promise<void> => {
      apiServer.server = null;
      await expect(apiServer.stop()).resolves.toBeUndefined();
    });
  });

  describe('handleRequest', (): void => {
    let mockReq, mockRes;
    ...
    it('should handle OPTIONS request for CORS', async (): Promise<void> => {
    ...
    it('should reject request without API key', async (): Promise<void> => {
    ...
    it('should reject request when rate limited', async (): Promise<void> => {
    ...
    it('should handle request with body', async (): Promise<void> => {
      mockReq.method = 'POST';
  ...
  describe('API endpoints', (): void => {
    ...
    describe('metrics endpoint', (): void => {
      it('should return metrics when enabled', async (): Promise<void> => {
      ...
      it('should return message when metrics not enabled', async (): Promise<void> => {
    ...
    describe('user endpoints', (): void => {
      ...
      it('should get user stats', async (): Promise<void> => {
      ...
      it('should handle user stats error', async (): Promise<void> => {
      ...
      it('should get user points when module exists', async (): Promise<void> => {
      ...
      it('should return 404 when points module not found', async (): Promise<void> => {
        await apiServer.handleGetUserPoints(context);
      ...
      it('should get user history with limit', async (): Promise<void> => {
    ...
    describe('leaderboard endpoints', (): void => {
      it('should get leaderboard with pagination', async (): Promise<void> => {
      ...
      it('should get user position in leaderboard', async (): Promise<void> => {
        const mockLeaderboardModule = {
    ...
    describe('track event endpoint', (): void => {
      it('should track event successfully', async (): Promise<void> => {
      ...
      it('should require eventName', async (): Promise<void> => {
      ...
      it('should handle invalid body', async (): Promise<void> => {
        context.body = null;
        await apiServer.handleTrackEvent(context);
        expect(context.res.writeHead).toHaveBeenCalledWith(400, { 'Content-Type': 'application/json' });
    ...
    describe('admin endpoints', (): void => {
      ...
      it('should handle manual award for badges', async (): Promise<void> => {
      ...
      it('should handle manual award for xp', async (): Promise<void> => {
      ...
      it('should reject unknown award type', async (): Promise<void> => {
        context.body = {
          userId: 'user123',
          type: 'unknown',
          value: 100
      ...
      it('should require all fields for manual award', async (): Promise<void> => {
        context.body = {
          userId: 'user123',
          type: 'points'
        };
  ...
  describe('WebSocket handling', (): void => {
  ...
  describe('rate limiting', (): void => {
    ...
    it('should reset rate limit after window', async (): Promise<void> => {
  ...
  describe('CORS handling', (): void => {
    ...
    it('should not set CORS headers when disabled', async (): Promise<void> => {
  ...
  describe('body parsing', (): void => {
    it('should parse valid JSON body', async (): Promise<void> => {
    ...
    it('should return null for invalid JSON', async (): Promise<void> => {
      const mockReq = new EventEmitter();
      const bodyPromise = apiServer.parseBody(mockReq);
    ...
    it('should handle request errors', async (): Promise<void> => {
      const mockReq = new EventEmitter();
      const bodyPromise = apiServer.parseBody(mockReq);
