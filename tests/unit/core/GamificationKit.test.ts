...
describe('GamificationKit', (): void => {
  ...
  describe('initialize', (): void => {
    it('should initialize with memory storage', async (): Promise<void> => {
      await gk.initialize();
    ...
    it('should initialize with different storage types', async (): Promise<void> => {
      const customGK = new GamificationKit({
        storage: { type: 'memory' },
        api: { enabled: false },
        websocket: { enabled: false },
    ...
    it('should return self if already initialized', async (): Promise<void> => {
      await gk.initialize();
      const result = await gk.initialize();
      expect(result).toBe(gk);
    });

    it('should initialize all registered modules', async (): Promise<void> => {
    ...
    it('should setup cross-module event listeners', async (): Promise<void> => {
      const pointsModule = new PointsModule();
      const badgeModule = new BadgeModule();
  ...
  describe('use', (): void => {
    ...
    it('should initialize module if GK is already initialized', async (): Promise<void> => {
      await gk.initialize();
  ...
  describe('track', (): void => {
    ...
    it('should emit event through event manager', async (): Promise<void> => {
    ...
    it('should process rules when enabled', async (): Promise<void> => {
    ...
    it('should collect metrics when enabled', async (): Promise<void> => {
    ...
    it('should trigger webhooks when enabled', async (): Promise<void> => {
      const customGK = new GamificationKit({ 
        webhooks: { enabled: true },
        api: { enabled: false },
        websocket: { enabled: false }
    ...
    it('should throw error if not initialized', async (): Promise<void> => {
  ...
  describe('getUserStats', (): void => {
    ...
    it('should handle modules without getUserStats', async (): Promise<void> => {
      const customModule = {
        name: 'custom',
        initialize: jest.fn(),
        setContext: jest.fn()
    ...
    it('should return basic stats structure', async (): Promise<void> => {
      const stats = await gk.getUserStats('user123');
  ...
  describe('resetUser', (): void => {
    ...
    it('should reset data in all modules', async (): Promise<void> => {
      // Setup some data
      const pointsModule = gk.modules.get('points');
      const badgeModule = gk.modules.get('badges');
    ...
    it('should handle modules without resetUser method', async (): Promise<void> => {
      const customModule = {
        name: 'custom',
        initialize: jest.fn(),
        setContext: jest.fn()
  ...
  describe('module access', (): void => {
    it('should access registered module via Map', async (): Promise<void> => {
      const pointsModule = new PointsModule();
      gk.use(pointsModule);
      await gk.initialize();
  ...
  describe('shutdown', (): void => {
    ...
    it('should disconnect storage', async (): Promise<void> => {
    ...
    it('should stop metrics collector', async (): Promise<void> => {
    ...
    it('should set initialized to false', async (): Promise<void> => {
      await gk.shutdown();
      expect(gk.initialized).toBe(false);
    });

    it('should shutdown all modules', async (): Promise<void> => {
      const module = gk.modules.get('points');
    ...
    it('should destroy event manager', async (): Promise<void> => {
  ...
  describe('rule processing', (): void => {
    ...
    it('should execute rule actions', async (): Promise<void> => {
      const pointsModule = gk.modules.get('points');
    ...
    it('should handle complex rule conditions', async (): Promise<void> => {
  ...
  describe('event flow', (): void => {
    it('should propagate events between modules', async (): Promise<void> => {
      const pointsModule = new PointsModule();
      const badgeModule = new BadgeModule();
  ...
  describe('error handling', (): void => {
    it('should handle module initialization errors', async (): Promise<void> => {
      const errorModule = {
        name: 'error',
    ...
    it('should handle storage initialization errors', async (): Promise<void> => {
      const customGK = new GamificationKit({
    ...
    it('should continue tracking even if metrics fail', async (): Promise<void> => {
      await gk.initialize();
  ...
  describe('additional features', (): void => {
    it('should provide health check', async (): Promise<void> => {
      const pointsModule = new PointsModule();
      gk.use(pointsModule);
      await gk.initialize();
    ...
    it('should provide metrics', async (): Promise<void> => {
      await gk.initialize();
  ...
  describe('performance', (): void => {
    it('should handle high-frequency events efficiently', async (): Promise<void> => {
      await gk.initialize();
