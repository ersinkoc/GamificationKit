...
describe('PostgresStorage', (): void => {
  ...
  describe('connect', (): void => {
    ...
    it('should create tables on connect', async (): Promise<void> => {
  ...
  describe('key-value operations', (): void => {
    ...
    describe('delete', (): void => {
      it('should delete key from all tables', async (): Promise<void> => {
    ...
    describe('exists', (): void => {
      ...
      it('should check all tables', async (): Promise<void> => {
        mockPool.query
    ...
    describe('mget/mset', (): void => {
      ...
      it('should set multiple values in transaction', async (): Promise<void> => {
    ...
    describe('keys', (): void => {
      ...
      it('should convert pattern to SQL LIKE', async (): Promise<void> => {
  ...
  describe('cleanup job', (): void => {
    it('should run cleanup periodically', async (): Promise<void> => {
      storage.startCleanupJob();
    ...
    it('should handle cleanup errors', async (): Promise<void> => {
